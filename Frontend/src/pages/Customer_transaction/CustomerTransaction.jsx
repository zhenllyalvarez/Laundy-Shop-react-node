...
const CustomerTransaction = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8080/api/customer/transaction/list?status=0", {
    ...
    <>
      ...
      <div className="p-4 sm:ml-64">
        <div>
          ...
          <p className="mb-14  text-gray-500 font-light">
            You can add a new transaction here, and once it's submitted, you'll
                  ...
                  return (
                    <tr key={i} className="bg-white border-b hover:bg-gray-50">
                      ...
                      <td className="flex gap-2 px-6 py-4">
                        ...
                        <Link
                          to={`/UpdateCustomerTransaction/${data.id}`}
