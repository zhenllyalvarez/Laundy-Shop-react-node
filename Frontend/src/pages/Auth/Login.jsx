...
import BtnSpinner from "../../components/TransactionCount/BtnSpinner";
    ...
    <>
      <div className="bg-white py-4 sm:py-8 lg:py-4">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <h2 className="text-center text-2xl font-bold text-gray-800 md:mb-8 lg:text-3xl">
            Login
          </h2>
          <form
            onSubmit={handleLogin}
            className="mx-auto max-w-lg rounded-lg border shadow-md bg-gray-50"
          >
