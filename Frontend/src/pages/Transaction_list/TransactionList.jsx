      ...
      <div className="p-4 sm:ml-64">
        <div>
          ...
          <p className="mb-8 text-gray-500 font-light">
            ...
            quibusdam impedit, quisquam exercitationem, laboriosam quis, nobis
            optio sint <br /> temporibus amet mollitia sequi commodi suscipit
            reiciendis deserunt error voluptate. Explicabo, nobis.
          </p>
          <div
          ...
          >
            <div className="flex flex-col sm:flex-row md:flex-row gap-2">
              <input
                className="w-full lg:w-60 md:w-60 outline-0 bg-gray-100 px-4 h-12 mb-2 text-gray-500 rounded shadow"
                type="search"
                name="search"
                id=""
                ...
                {paginatedData.map((data, i) => {
                  return (
                    <tr key={i} className="bg-white border-b hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">{data.kilo}</td>
            ...
            <div className="flex items-center text-gray-600 justify-between px-4">
              <div>
                <Pagination
                  className="p-2"
                  current={currentPage}
